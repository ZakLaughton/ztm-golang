...
// func parseTimeString(timeString string) (TimeComponents, error) {
// 	parts := strings.Split(timeString, ":")
// 	if len(parts) != 3 {
// 		return TimeComponents{}, errors.New("invalid time format")
// 	}

// 	hour, err := strconv.Atoi(parts[0])
// 	if err != nil {
// 		return TimeComponents{}, errors.New("invalid hour component")
// 	}

// 	minute, err := strconv.Atoi(parts[1])
// 	if err != nil {
// 		return TimeComponents{}, errors.New("invalid minute component")
// 	}

// 	second, err := strconv.Atoi(parts[2])
// 	if err != nil {
// 		return TimeComponents{}, errors.New("invalid second component")
// 	}

// 	return TimeComponents{Hour: hour, Minute: minute, Second: second}, nil
// }
